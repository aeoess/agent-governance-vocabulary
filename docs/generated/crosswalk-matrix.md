...
Auto-generated on 2026-07-26. 21 systems × 15 canonical signal types.
...
|---|---|---|
| `wallet_state` | 21 / 21 | 100% |
| `compliance_risk` | 20 / 21 | 95% |
| `settlement_witness` | 20 / 21 | 95% |
| `behavioral_trust` | 19 / 21 | 90% |
| `governance_attestation` | 19 / 21 | 90% |
| `job_performance` | 18 / 21 | 86% |
| `passport_grade` | 18 / 21 | 86% |
| `reasoning_integrity` | 18 / 21 | 86% |
| `security_posture` | 18 / 21 | 86% |
| `trust_verification` | 18 / 21 | 86% |
| `wallet_intelligence` | 18 / 21 | 86% |
| `peer_review` | 14 / 21 | 67% |
| `entity_continuity` | 11 / 21 | 52% |
| `completion_ratio` | 3 / 21 | 14% |
| `cognitive_attestation` | 1 / 21 | 5% |
